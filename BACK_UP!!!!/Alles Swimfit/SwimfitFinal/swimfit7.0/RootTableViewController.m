...
- (void)viewDidLoad {
    [super viewDidLoad];
    menue = [NSArray arrayWithObjects:@"Training", @"Coach", @"Facts", @"Pools", @"Open Water", @"Clubs", @"Competition" @"Equipment", nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    static NSString *simpleTableviewIdentifier = @"menueCell";
    ...
    cell.textLabel.text = [menue objectAtIndex:indexPath.row];
